//AVL DE LA PROFA PERO LO MODIFIQUE PA SIRVA CON FECHAS. EN SI NO DEBERIA PERO SE ME HACIA MAS FACIL ENTENDERLO. IGUAL LO
...
struct NodoFecha {
    ...
    Nodo(Asistente* a) : Asistente(a), factor_balance(0), izq(nullptr), der(nullptr), padre(nullptr) {}
};
...
void ArbolAVL::mostrarEchado(Nodo* nodo, int nivel) {
    ...
    bool compararAsistentes(Asistente* a1, Asistente* a2) {
    return strcmp(a1->getDNI(), a2->getDNI()) < 0;
}
